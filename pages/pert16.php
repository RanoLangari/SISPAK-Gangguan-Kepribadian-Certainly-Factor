...
$queryData = "SELECT * FROM tgejala WHERE id_gejala = 'G16'";
$gejala = mysqli_query($conn, $queryData);
$fetchGejala = mysqli_fetch_assoc($gejala);


// cek data gejala sudah ada atau belum
$queryCek = "SELECT * FROM diagnosis LEFT JOIN tuser ON diagnosis.idduser = tuser.id_tuser WHERE tuser.username = '$user' AND diagnosis.iddgej = 'G16'";
...
<head>
    ...
    <title>Kuisioner Halaman 16</title>
    <!-- Bootstrap CSS -->
                ...
                <form action="" method="post">
                    ...
                    <div class="row mt-5">
                        <div class="col d-flex justify-content-start">
                            <a href="pert15.php" class="btn btn-primary float-left btn-lg">Previous</a>
                        </div>
