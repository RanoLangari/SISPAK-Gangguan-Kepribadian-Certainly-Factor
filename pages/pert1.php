...
$queryData = "SELECT * FROM tgejala WHERE id_gejala = 'G01'";
$gejala = mysqli_query($conn, $queryData);
$fetchGejala = mysqli_fetch_assoc($gejala);


// cek data gejala sudah ada atau belum
$queryCek = "SELECT * FROM diagnosis LEFT JOIN tuser ON diagnosis.idduser = tuser.id_tuser WHERE tuser.username = '$user' AND diagnosis.iddgej = 'G01'";
...
<head>
    ...
    <title>Kuisioner Halaman 1</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" name="tambah" class="btn btn-primary btn-lg">Next</button>
                    </div>
                </form>
            </div>
        </div>
