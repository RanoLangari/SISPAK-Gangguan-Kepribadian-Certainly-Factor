...
if (isset($_POST["tambah"])) {
    ...
    if (tmbgejala($_POST) > 0) {
        ...
        echo "<script>
        document.location.href = 'tbldiagnosis.php';
        </script>";
    } else {
        echo "<script>
        alert('Data Gagal Ditambahkan');
        document.location.href = 'pert46.php';
        </script>";
    }
}
...
<head>
    ...
    <title>Kuisioner Halaman 46</title>
    <!-- Bootstrap CSS -->
                ...
                <form action="" method="post">
                    ...
                    <div class="row mt-5">
                        <div class="col d-flex justify-content-start">
                            <a href="pert45.php" class="btn btn-primary float-left btn-lg">Previous</a>
                        </div>
                        <div class="col d-flex justify-content-end">
                            <button type="submit" name="tambah" class="btn btn-primary float-right btn-lg" onclick="return confirm('Pastikan Mengisi Semua Gejala!')">Next</button>
