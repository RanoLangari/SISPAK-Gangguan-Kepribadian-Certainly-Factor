    ...
    <div id="wrapper">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                                <form method="post" class="form-inline mr-auto w-100 navbar-search">
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small keyword" id="keywordg2" placeholder="Cari.." aria-label="Search" aria-describedby="basic-addon2" name="keywordg2">
                    ...
                    <div class="container-fluid ">
                        ...
                        <div class="row" id="row-info-user">
                            ...
                            <div class="col" id="btn_reg">
                                ...
                                <button class="btn btn-light text-primary mb-1 font-weight-bold btn-sm border border-primary rounded-pill" style="margin-left:170px;" data-toggle="modal" data-target="#exampleModal" type="button" id="btn-admin">Tambah Gejala <i class="fa fa-file-medical"></i></button>

                                <a href="../gcetak.php" class="btn btn-light text-primary border border-primary rounded-pill font-weight-bold mb-1 btn-sm">Cetak
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a id="ubahg" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ubah_data" data-id="<?= $ge['id_gejala']; ?>" data-gejala="<?= $ge['n_gejala']; ?>"><i class="fa fa-edit"></i> edit</a>
                                                                    <a id="hapus" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus_data<?= $ge['id_gejala']; ?>"><i class="fa fa-trash"></i> Hapus</a>
                                                                </td>
                                                            </tr>
        ...
        <?php foreach ($gejala as $gej) : ?>
            <form method="post" action="">
                <div class="modal fade" id="hapus_data<?= $gej['id_gejala'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <input class="form-control" type="text" id="idG" name="idG" hidden value="<?= $gej['id_gejala'] ?>">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-dark font-weight-bold" id="exampleModalLabel"><i class="fa fa-file-medical fa-lg"></i> Tambah Gejala</h5>
        ...
        <div class="modal fade" id="ubah_data" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-dark font-weight-bold" id="exampleModalLabel"><i class="fa fa-edit fa-lg"></i> Ubah Data Gejala</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark" data-dismiss="modal">Batal</button>
                        <button type="submit" name="btnubah" class="btn btn-primary" onclick="return confirm('Anda Yakin Ingin Mengubah Data Gejala?');">Ubah</button>
                    </div>
                    </form>
                </div>
            </div>
